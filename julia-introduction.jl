...
# ╔═╡ 01f3ea52-11d9-4bf4-a1e3-88f425e0d428
using Plots

# ╔═╡ 5d6c2357-6aa6-415f-8da6-e70dd9de8c25
using Measurements

# ╔═╡ f15e330f-7e9b-47cc-a71c-3db5318e00c0
using Statistics

# ╔═╡ be17036a-95a1-408d-a6ce-e1b9e072773f
using PyCall
...
md"""
# Welcome to Julia Introduction in 20 minutes

**Key message:** Julia is easier than Python, and faster

What you will see:
* we start with basic Julia
* see how to interact with Python
* compare performance

My name is Stephan Sahm, founder of [Jolin.io](https://www.jolin.io) an IT consultancy with focus on Julia.
"""

# ╔═╡ 04bed6e2-4514-4975-ba0e-991bd55853b7
md"""
## "What is this notebook?" you may ask.
It is a Pluto notebook - a reactive version of jupyter, but currently Julia only.
"""
...
@bind b html"<input type=range>"

# ╔═╡ 0099e358-0a4f-4b1c-84fa-16305b4e8dfe
c = [a  2b
	 3a 4b]

# ╔═╡ 7f54a964-fa11-48c7-b8e1-deb056d9ff98
d = c .+ 10  # broadcast by using dot .

# ╔═╡ 47555833-d451-4541-9374-ddb69d44dcbe
...
1. structs with speed like C
2. overloadable functions
"""
...
# ╔═╡ 17698101-5435-4c87-a5cc-8c861810a1e3
md"""
## Example Package in Action
"""

# ╔═╡ ae4db800-07ac-4581-93bf-0b0525285981
x = rand(10) .* 5

# ╔═╡ 80044a37-29db-4b2e-afe8-f395ecce38dc
y = x .± rand(10)

# ╔═╡ 1b0a482d-a971-4d5f-831f-e9443e3bf0aa
begin
	p1 = plot(x)
	p2 = plot(y)
	plot(p1, p2)
...
# ╔═╡ d9866265-db8f-4a18-b397-6bc7e436f653
mean(x)

# ╔═╡ 1f6ba159-05fc-4861-be1b-cf182756f898
mean(y)

# ╔═╡ cb951694-60f9-4fa6-94e7-c254ce9c156d
md"""
## Use whatever Python/Fortran/C++/C you like
...
The example is adapted from https://juliacomputing.com/assets/pdf/JuliaVsPython.pdf which reported similar values for an older version of Julia vs Python2.7
"""

# ╔═╡ 77ee3f66-65e2-457a-9dae-c26e126f0efb
md"""
With this julia is about 50 times more performant than Python.

The Python version takes about 4.5 minutes (270.9 seconds) on my machine. 200x200 already takes 7 seconds, i.e. longer than the julia version for 1000x1000.

It is using some numpy, but main part is done in Python. Still it illustrates very well how easy it is to write performant code in Julia.
"""
...
begin
	...
	py"timeit.timeit(lambda: mandelbrot_set(width=200, height=200), number = 1)"
end
